...
import com.zolfagharipour.resume.theme.AppColors
import com.zolfagharipour.resume.util.*
import org.jetbrains.compose.web.css.*
import org.jetbrains.compose.web.dom.P
import org.jetbrains.compose.web.dom.Text

private const val SPACE_SIZE = 10
...
private fun BulletTextComponent(
    ...
    P(
        attrs = modifier
            ...
            .fgColor(FGColor.Body)
            .textSize()
            .heightLine(heightLine = HeightLine.Small)
            .toAttrs()
    ) { Text(text) }
}
