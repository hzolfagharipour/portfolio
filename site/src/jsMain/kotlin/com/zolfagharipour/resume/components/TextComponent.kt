...
fun BodyTextBold(
    ...
    fgColor: FGColor = FGColor.Headline3,
...
fun Headline1(
    ...
    marginTop: CSSNumeric = AppConstants.Size.Margin.BETWEEN_SECTIONS.px,
) {
...
fun Headline3(
    ...
    B(
        attrs = Modifier
            ...
            .fillMaxWidth()
            .textAlign(TextAlign.Start)
            .fgColor(FGColor.Headline3)
            .margin(0.px)
            .padding(0.px)
            .textSize(TextSize.Headline3)
            .toAttrs()
    ) { Text(title) }
}
...
fun InfoLine(
    ...
    Row(
        ...
        FaCircleInfo(size = IconSize.LG, modifier = Modifier.fgColor(FGColor.Headline2))
        Spacing(width = 4.px)
        BodyTextBold(
            text = text,
            modifier = Modifier
