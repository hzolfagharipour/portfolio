...
object AppConstants {
    ...
    object ID {
        ...
        const val HOME = "home"
        const val COROUTINE_FLOW = "coroutine-flow"
        const val PORTFOLIO = "portfolio"
        const val WALLET = "wallet"
        const val APP_STORE = "app-store"
    ...
    object SectionTitle {
        ...
        const val PROJECT = "Personal Endeavors"
        const val EXPERIENCE = "Experience"
        const val RECOMMENDATION = "Recommendation"
        const val CONTACT = "Get in Touch"
    }
        ...
        object Coroutine {
            ...
            val DESCRIPTIONS = listOf(
                "This is a comprehensive guide that takes you on an immersive journey into the world of Android development and Kotlin programming. With over 350 pages of carefully crafted content, this book is your ultimate companion for mastering of asynchronous programming using Coroutine and Flow. " +
                        "The book is organized into 3 fundamental chapters: Coroutine, Flow, and Channel. Each chapter extensively delves into a thorough examination of operators, properties, and functions. It offers an invaluable opportunity for those curious about what is happening behind the scenes. The book covers testing functions, best practices, and Coroutine-aware solutions for prevalent challenges in the Android world."
            )
            const val DEMO_TITLE = "Table of content"
            const val DEMO_DES =
                "Feel free to download a portion of the book to get a comprehensive view of what each chapter covers."

            const val BUY_TITLE = "Buy in Amazon"
            const val BUY_DES =
