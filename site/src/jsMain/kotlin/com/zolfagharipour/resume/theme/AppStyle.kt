...
import com.zolfagharipour.resume.util.lightOrDarkWork
import com.zolfagharipour.resume.util.pointerCursor
import org.jetbrains.compose.web.css.*

val LightHoverIconStyle by ComponentStyle {
    base {
        Modifier
            .color(AppColors.LightColorDeactivateTint())
            .transition(CSSTransition(property = "color", duration = 200.ms))
    }

    hover {
        Modifier
            .color(AppColors.LightColorActivateTint())
            .pointerCursor()
    }
}
...
val DarkHoverIconStyle by ComponentStyle {
    ...
    hover {
        Modifier
            .color(AppColors.DarkColorActivateTint())
            .pointerCursor()
    }
}
...
@Composable
fun recommendationCardStyle() = lightOrDarkWork(
